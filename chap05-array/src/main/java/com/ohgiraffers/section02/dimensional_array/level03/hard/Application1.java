package com.ohgiraffers.section02.dimensional_array.level03.hard;
	...
	public static void main(String[] args) {
		...
		* W S S J 
		...
		while(true) {
			...
			if(rowCount < numRangeMin || rowCount > numRangeMax || colCount < numRangeMin || colCount > numRangeMax) {
				System.out.println("반드시 1~10까지의 정수를 입력해야 합니다. 다시 입력하세요.");				
			} else {
				rarr = new char[rowCount][colCount];
				break;
			}
		}
