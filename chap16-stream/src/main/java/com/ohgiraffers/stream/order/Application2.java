package com.ohgiraffers.stream.order;
...
public class Application2 {
   ...
   public static void main(String[] args) {
       ...
       List<String> completedOrderIds = // 코드 작성
       orders.stream()
       ...
       Map<String, Double> totalAmountByCustomer = 
       orders.stream()
               .collect(Collectors
               .groupingBy(Order::getCustomerName, Collectors
               .summingDouble(Order::getTotalAmount)));
               

               // 3. 가장 높은 주문 금액을 가진 고객의 이름을 반환
               String highestOrderCustomer = // 코드 작성
               orders.stream()
